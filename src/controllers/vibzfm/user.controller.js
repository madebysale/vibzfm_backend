...
export const forgetpassword = async (req, res, next) => {
  try {
    ...
    const transporter = nodemailer.createTransport({
      host: "mail.impetrosys.com", // SMTP server host for your domain mail.impetrosys.co
      port: 465, // Port for secure SMTP (e.g., 587 for TLS)  mailto:anilsingh@impetrosys.com
      secure: true,
      debug: true,
      auth: {
        user: "anilsingh@impetrosys.com", // Your email address
        pass: "impetrosys@010",
      },
    ...
    let mailOptions = {
      from: "anilsingh@impetrosys.coms",
      to: req.body.email,
